...
class UpdateProductRequest extends FormRequest
{
     ...
     *
     * Untuk memperbarui produk yang ada, kita memvalidasi beberapa field seperti 'category_id', 'name', 'description',
     * 'qty', dan 'price'. Semua field tersebut wajib diisi dan terdapat beberapa aturan tambahan
